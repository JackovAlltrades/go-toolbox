# Script to create the toolbox cheatsheet

# Ensure the notes directory exists
$notesDir = "H:\Projects\toolbox-project\notes"
if (-not (Test-Path $notesDir)) {
    New-Item -ItemType Directory -Path $notesDir -Force | Out-Null
    Write-Host "Created notes directory" -ForegroundColor Green
}

# Create the cheatsheet content as a simple string instead of a here-string
$cheatsheetContent = "# Go Toolbox Project Cheat Sheet
